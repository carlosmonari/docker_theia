...
RUN sed -i 's/\r$//' /*.sh ; chmod +x /*.sh && \
	...
	echo "monari/theia" >> /.image_names && \
	echo "monari/theia" > /.image_name
...
#docker build -t monari/theia:latest .
#docker rm -f theia; docker run -it --privileged -p 15050:5050 --expose 9229 -p 19229:9229 -v "$(pwd):/home/project:cached" -e "username=monari" -e "password=fcea920f7412b5da7be0cf42b8c93759" --name theia monari/theia:latest
#docker rm -f theia; docker run -it --privileged --expose 1080 -p 1080:1080 --expose 3000 -p 3000:3000 -p 15050:5050 --expose 9229 -p 19229:9229 -v "$(pwd):/home/project:cached" -e "username=monari" -e "password=fcea920f7412b5da7be0cf42b8c93759" --name theia monari/theia:latest
